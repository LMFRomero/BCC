...
VirtualRegistry *registry_manager_read_current(RegistryManager *manager) {
	...
	//TODO: colocar essa checagem no binary_read_registry de alguma forma. OBS: ver se não saiu pro fim do arquivo também
...
bool registry_manager_is_current_deleted (RegistryManager *manager) {
	...
	//TODO: achar jeito de minimizar isso
